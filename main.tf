...
"mkdir /home/ec2-user/setup",
	  ...
	  "cd linuxscripts",
	  "chmod 777 *.*",
"sh get_oracle_jdk_linux_x64.sh",
"mkdir /home/ec2-user/java/",
"FILENAME=\"$(ls -Art *.gz | tail -n 1)\"",
"tar xzf $FILENAME -C /home/ec2-user/java/ --strip-components=1",
...
"cd /home/ec2-user/setup/linuxscripts",
"wget http://ftp.cixug.es/apache/tomcat/tomcat-7/v7.0.84/bin/apache-tomcat-7.0.84.tar.gz",
"tar zxpvf apache-tomcat-7.0.84.tar.gz -C /home/ec2-user/tomcat --strip-components=1",
"yes | cp -f tomcat-users.xml /home/ec2-user/tomcat/conf/",
"cd /home/ec2-user/tomcat/bin",
"sh startup.sh",
"yes | sudo cp -f /home/ec2-user/setup/linuxscripts/nginx.conf /etc/nginx/",
